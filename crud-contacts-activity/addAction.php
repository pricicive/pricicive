...
<body>
    <div class="container mt-5">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!is_numeric($number) || $number < 0 || $number > 99999999999) {
                echo '<div class="alert alert-danger" role="alert">';
                echo "Number must be a valid positive number and less than 10 digits.<br/>";
                echo '</div>';
            } else {
        ...
        <form action="" method="post" class="mt-4">
            ...
            <div class="form-group">
                ...
                <input type="number" name="number" class="form-control" id="number" required min="0" max="9999999999">
            </div>
            <div class="form-group">
